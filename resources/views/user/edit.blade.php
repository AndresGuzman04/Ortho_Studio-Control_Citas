    ...
    <div class="card text-bg-light">
        <form action="{{ route('users.update',['user' => $user]) }}" method="post">
            ...
            <div class="card-body">
                ...
                <!---Puesto---->
                <div class="row mb-4">
                    <label for="puesto" class="col-lg-2 col-form-label">Puesto:</label>
                    <div class="col-lg-4">
                        <input autocomplete="off" type="text" name="puesto"
                            id="puesto" class="form-control" value="{{old('puesto',$user->puesto)}}"
                            aria-labelledby="nameHelpBlock">
                    </div>
                    <div class="col-lg-4">
                        <div class="form-text" id="passwordHelpBlock">
                            Puesto del usuario en la clínica.
                        </div>
                    </div>
                    <div class="col-lg-2">
                        @error('puesto')
